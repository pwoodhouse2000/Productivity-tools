...
properties = {
    ...
    "Todoist URL": {"url": f"https://todoist.com/app/task/{task_data['id']}"}
}
...
if todoist_id:
    ...
    try:
        ...
        check_response = requests.get(f"https://api.todoist.com/rest/v2/tasks/{todoist_id}", headers=headers)
        ...
        if check_response.status_code == 200:
            ...
            if is_done and not todoist_is_completed:
                ...
                # Reopen in Todoist
                requests.post(f"https://api.todoist.com/rest/v2/tasks/{todoist_id}/reopen", headers=headers).raise_for_status()
        ...
        if notion_task:
            ...
            if todoist_is_completed != notion_is_completed:
                if todoist_is_completed:
                    ...
                    requests.patch(f"https://api.notion.com/v1/pages/{notion_id}", headers=headers, json=update_data)
